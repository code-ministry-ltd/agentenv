...
| CLI and release | Settled commands, root globals, env-less global drop, Node floor, container restore | JJ CLI/release tests | Behavioral reimplementation | Implemented; packed restore smoke is green and the Docker gate is wired into CI |
